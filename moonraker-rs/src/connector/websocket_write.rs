...
impl Debug for OutboundMessage {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            OutboundMessage::MoonrakerRequest(req) => write!(
                f,
                "OutboundMessage::MoonrakerRequest id: {}, method: {}",
                req.id, req.method
            ),
        }
    }
...
impl MoonrakerConnectionWriteLoop {
    ...
    pub async fn connection_loop(&mut self) {
        loop {
            ...
            if let Err(e) = match &*message {
                ...
                OutboundMessage::MoonrakerRequest(request) => {
    ...
    pub async fn handle_moonraker_request(
        &mut self,
